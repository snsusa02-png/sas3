...
class CreatePrizeRateSetsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prize_rate_sets', function (Blueprint $table) {
            $table->id();
		...
		$table->foreign('ownorgid')->references('id')->on('orgs');
            ...
            $table->biginteger('prizetypeid')->unsigned()->comment('Тип начисления премии');
    ...
    {
        Schema::dropIfExists('prize_rate_sets');
    }
}

...
@section('content')
    ...
    @if (!isset( $rec ))
        ...
        header("Location:" . route('places.index'));
        die();
        ?>
    @else
        <?php
        $sysobjid = 109;
        $ThisTitle = "Место присутствия";
        $retRoute = route('places.index');
                ...
                <div class="col-md-7 col-sm-12">
                    ...
                    <div class="card mt-3">
                        ...
                        <form name="forEdit" id="forEdit" method="post"
                              action="{{ route('places.update', $rec->id) }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    {{--                                        <div class="input-group mb-3 ">--}}
                                    {{--                                            {!! Form::select('placetypeid', $rec->placetypes , old('name',$rec->placetypeid),--}}
                                    {{--['class' => 'form-control',--}}
                                    {{--'placeholder' => '',--}}
                                    {{--]) !!}--}}
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" rows="2"
                                                  name="descript"
                                        >{{old('descript',$rec->descript)}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" rows="2"
                                                  name="address"
                                                  placeholder="индекс, город, улица, дом, корпус, офис"
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="active">Актуально:</label>
                                ...
                                @if ($usrrights['delete'])
                                    <button type="submit"
                                            ...
                                            formaction="{{ route('places.delete', $rec->id)}}"
                                            formmethod="post"

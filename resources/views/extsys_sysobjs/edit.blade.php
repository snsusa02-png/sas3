...
@section('content')
	...
	@else
        <?php
        $sysobjid = 33;
        $sysobjcode = 'extsys_sysobjs';
        $thisTitle = "Получатель данных из внешней системы";

        $retRoute = route('extsystems.edit', $rec->extsysid);
				...
				<div class="col-md-6 col-sm-12">
					...
					<div class="card mt-3">
						...
						<form name="forEdit" id="forEdit" method="post"
							  action="{{ route($sysobjcode.'.update', [$rec->id,$rec->extsysid]) }}">
							...
							<div class="card-body">
								...
								<div class="form-group">
									<label for="name">Внешняя система:</label>
									<b>{{$rec->extsystem->name}}</b>
									{!! Form::hidden('extsysid',$rec->extsysid) !!}
								</div>
								<div class="form-group">
									<label for="name">Справочник:</label>
									{!! Form::select('sysobjid', $rec->sysobjs, $rec->sysobjid
									,['class' => 'form-control',
									'required' => 'required',
									'placeholder' => '-укажите-',
									]) !!}

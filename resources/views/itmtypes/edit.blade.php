                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <form name="forEdit" id="forEdit" method="post"
                                      action="{{ route('itmtypes.update', $rec->id) }}">
                                    @method('PUT')
                                    @csrf
...
'title'=>'Доступно для использования']) !!}
                                    ...
                                    @if ($usrrights['delete'])
                                        <button type="submit"
                                                ...
                                                formaction="{{ route('itmtypes.delete', $rec->id)}}"
                                                formmethod="post"
                                                title="Удалить"
                    ...
                    @if($rec->id<>-1)
                        <div class="col-md-5">
                            ...
                            @include('itmtypes.it_subtypes')

                            {{--						@include('itmtypes.it_specs')--}}

                            @include('itmtypes.it_extids')

                            {{--						@include('itmtypes.it_impgroups')--}}

...
@section('content')
    @if (!isset( $rec))
        <?php
        redirect()->route('mchn_spare_usages.index');
        header("Location:" . route('mchn_spare_usages.index'));
        die();
        ?>
    @else
        ...
        $ThisTitle = "Регистрация установки запасных частей а автомобиль";
                            ...
                            <form name="forEdit" id="forEdit" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group offset-md-0 col-md-9">
                                        <label for="name" class="">Запчасти:</label>
                                        @if ($usrrights['edit'])
                                            <div class="input-group mb-3 ">
                                                <input type="text" name="spare_name" id="spare_name"
                                                       class=" spare_name form-control font-weight-bold"
                                                       value="{{old('spare_name',$rec->spare_name)}}">
                                            </div>
                                        @else
                                            <div class="font-weight-bold">{{$rec->spare_name}}</div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group offset-md-3 col-md-3">
                                        <label for="name" class="" id="lbl_raid_qty">Кол-во, шт:</label>
                                        @if ($usrrights['edit'])
                                            <div class="input-group mb-3 ">
                                    ...
                                    <div class="form-group offset-md-0 col-md-3">
                                        ...
                                        @if ($usrrights['edit'])
                                            <div class="input-group mb-3 ">
                                                <input type="number" name="spare_sum" id="spare_sum" required
                                                       title="Общая стоимость топлива"
                                                       class="form-control text-right font-weight-bold"
                                                       min="0" step="0.01"
                                                       value="{{old('spare_sum',$rec->spare_sum)}}">
                                            </div>
                                        @else
                                            <div class="font-weight-bold">{{$rec->spare_sum}}</div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group offset-md-3 col-md-9">
                                        <label for="name" class="required">Установлено на автомобиль:</label>
                                        @if ($usrrights['edit'])
                                            <div class="input-group mb-3 ">
                                ...
                                @endif
                                @if (1==0 and $usrrights['admindelete'])
                                    <button type="submit"
                                            class="btn btn-danger btn-sm"
        ...
        <script src="{{ asset('js/mchn_spare_usage_edit.js') }}" defer></script>

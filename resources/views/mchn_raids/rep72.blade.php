                ...
                <div class="page p-2 container-fluid">
                    ...
                    <table class="table table-sm table-striped rep-data mt-3"
                        ...
                        <tr class="text-left small" valign="top">
                            ...
                            <td class="text-left">Сколько купили, ЕИ</td>
                            <td class="text-left">Сколько купили, м3</td>
                            <td class="text-left">У кого купили</td>
                            <td class="text-left">Место загрузки</td>

                            <td class="text-left">Что продали</td>
                            <td class="text-left">Сколько продали, ЕИ</td>
                            <td class="text-left">Сколько продали, м3</td>
                        ...
                        @foreach($recs as $rec)
                            ...
                            <tr class="text-left">
                                ...
                                <td class="text-right small">
                                    @if($rec->buy_qty <> 0)
                                        {{number_format($rec->buy_qty,3)}}
                                        {{$rec->unit_name}}
                                    @endif
                                </td>
                                <td class="text-right small">
                                    @if($rec->buy_qty_m3 <> 0)
                                        {{number_format($rec->buy_qty_m3,3)}}
                                    @endif
                                </td>
                                ...
                                <td class="text-right small">
                                    @if($rec->sale_qty <> 0)
                                        {{number_format($rec->sale_qty,3)}}
                                        {{$rec->unit_name}}
                                    @endif
                                </td>
                                <td class="text-right small">
                                    @if($rec->sale_qty_m3 <> 0)
                                        {{number_format($rec->sale_qty_m3,3)}}
                                    @endif
                                </td>
                        ...
                        @if(1==1)
                            ...
                            {{--                            </tr>--}}
                            <tr>
                                <td colspan="14" class="text-right">Всего:</td>

                        ...
                        <form name="forRep01" id="forRep01" method="post"
                            ...
                            @if(1==1)
                                <div class="row">
                                    ...
                                    @if(1==1)
                                    <div class="form-group col-md-2 dpt_1 dpt_9 " style="display: none">
                                        <label for="s_drivername" class="required0">Водитель:</label>
                                        <input type="text" class="form-control text-center"
                                               name="s_drivername" id="s_drivername"
                                               value="{{$search_params['s_drivername']??''}}"
                                        />
                                    </div>
                                    @endif
...
//                            $td_class = ($line_sum < 0) ? 'text-danger' : (($line_sum > 0) ? 'text-success' : '');
                            ...
                            <tr class="text-left">
                                ...
                                <td class="text-left small">{{$rec->drivername}}</td>
{{--                                <td class="text-right small">{{number_format($rec->raid_qty,0)}}</td>--}}
                                <td class="text-right small">{{number_format($rec->route_points,3)}}</td>
                            </tr>
                            <?php

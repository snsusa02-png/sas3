...
@section('content')
    ...
    <?php
    $thisTitle = "График занятости ИП за период";
					...
					<script type="text/javascript">
                        ...
                        function drawChart() {
                            ...
                            dataTable.addRows([
                                    ...
                                    ?>
                                ['{{$itm->driver_orgid.'. '.$itm->driver_orgname}}', '', '{{$wrkperiod.' '.$itm->machinename. ': '. $itm->drivername }}',

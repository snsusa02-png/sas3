...
<HEAD>
	...
	<TITLE>Транспортная накладная (УМТС-ИП)</TITLE>
		...
		<div class="params no-print card mt-3 d-print-none">
			...
			<div class="card-body">
				...
				<form name="forRep01" id="forRep01" method="post"
					  action="{{ route('mchnrqsts.print_transp_nakl_2', $id) }}">
					@csrf
...
<div class="page" style="">
	<TABLE FRAME=VOID CELLSPACING=0 COLS=58 RULES=NONE BORDER=0 class="pagebreak" align="center" style="max-width:980px;">
		<COLGROUP>
			<COL WIDTH=12>
			<COL WIDTH=12>
			<COL WIDTH=12>
		...
		<TR>
			...
			<TD STYLE="border-top: 1px solid #000000; border-right: 1px solid #000000"
				ALIGN=center colspan="29">Заказ (заявка)</TD>
		</TR>
		<TR>
			...
			<TD STYLE="border-bottom: 1px solid #000000; border-right: 1px solid #000000" colspan=12
				ALIGN=LEFT VALIGN=TOP><B><FONT
							COLOR="#993300">{{date_format(date_create($rec->fctbegdt), "d.m.Y")}}</FONT></B></TD>
		...
		<TR>
			...
			<TD STYLE="border-bottom: 1px solid #000000" colspan=26 ALIGN=CENTER VALIGN=TOP>
				<B>
				<!--ГРУЗООТПРАВИТЕЛЬ-->
				{{ ($rec->car_org->fullname<>'')?$rec->car_org->fullname : $rec->car_org->name}}, {{$rec->car_org->address}}
				</B></TD>
			<TD STYLE="border-right: 1px solid #000000"><br></td>
			<td/>
		...
		<TR>
			<TD STYLE="border-left: 1px solid #000000"><br></td>
			<TD colspan=26 ALIGN=CENTER VALIGN=TOP class="xs">(дата и время подачи транспортного средства под	погрузку)
			</TD>
			<TD STYLE="border-right: 1px solid #000000"><br></td>
			<td/>
			<TD colspan=27 ALIGN=CENTER VALIGN=TOP BGCOLOR="#FFFFFF" class="xs">(дата и время подачи транспортного средства под	выгрузку)
			</TD>
			<TD STYLE="border-right: 1px solid #000000"><br></td>
		</TR>
		<TR>
		...
		<TR>
			...
			<TD colspan=27 ALIGN=CENTER VALIGN=TOP BGCOLOR="#FFFFFF" class="xs">(фактическое состояние груза, тары,
				упаковки,	маркировки и опломбирования)
			</TD>
			<TD STYLE="border-right: 1px solid #000000"><br></td>
		</TR>
		<TR>
		...
		<TR>
			...
			<TD STYLE="border-bottom: 1px solid #000000" colspan=26 ALIGN=LEFT>
				<B>{{$rec->car_org->boss_postname??'Руководитель организации'}}
					<span style="width:100px;display: inline-block">&nbsp;</span>
					{{$rec->car_org->boss_name??$rec->car_org->boss_fullname}}
				</B>
			</TD>
			<TD STYLE="border-right: 1px solid #000000"><br></td>
			<td/>
		...
		<TR>
			...
			<TD colspan=26 ALIGN=CENTER VALIGN=TOP class="xs">(должность,подпись,расшифровка подписи
				грузоотправителя(уполномоченного
				лица))
			</TD>
			<TD STYLE="border-right: 1px solid #000000"><br></td>
			<td/>
		...
		<TR>
			...
			<TD STYLE="border-bottom: 1px solid #000000" colspan=38 ALIGN=CENTER><B><FONT
							SIZE=2>{{$rec->driver_org->name}}</FONT></B></TD>
			<td/>
	...
	<TABLE FRAME=VOID CELLSPACING=0 COLS=58 RULES=NONE BORDER=0 class="pagebreak" align="center">
		...
		<TR>
			...
			<TD STYLE="border-bottom: 1px solid #000000" colspan=55 ALIGN=CENTER BGCOLOR="#FFFFFF"><B><FONT
							SIZE=1>
						{{$rec->driver_org->fullname??$rec->driver_org->name}}
						{{isset($rec->driver_org->inn)?'ИНН '.$rec->driver_org->inn:'' }} {{$rec->driver_org->address}}
		...
		<TR>
			...
			<TD STYLE="border-bottom: 1px solid #000000" colspan=55 ALIGN=CENTER><B><FONT
							SIZE=2>{{$rec->drivername}}</FONT></B></TD>
			<TD STYLE="border-right: 1px solid #000000"><br></td>
			<td/>
		</TR>
		<TR>
		...
		<TR>
			...
			<TD STYLE="border-bottom: 1px solid #000000" colspan=22 ALIGN=LEFT><B><I><FONT SIZE=2>1
							{{$rec->fct_priceunit}}={{$rec->driver_price}} руб. {{$rec->vat_info}}</FONT></I></B></TD>
			<td/>
			<TD STYLE="border-left: 1px solid #000000"><br></td>
		...
		<TR>
			...
			<TD STYLE="border-bottom: 1px solid #000000" colspan=22 ALIGN=CENTER><I><FONT SIZE=2>{{$rec->fct_qty}}
						х{{$rec->fct_priceunit}}={{$rec->fct_qty*$rec->driver_price}} руб   {{$rec->vat_sum}}</FONT></I>
			</TD>
			<td/>
			<TD STYLE="border-left: 1px solid #000000"><br></td>
		...
		<TR>
			...
			<TD STYLE="border-bottom: 1px solid #000000" colspan=55 ALIGN=CENTER VALIGN=MIDDLE><B>
					{{$rec->car_org->name}}, {{$rec->car_org->address}}, ИНН/КПП {{$rec->car_org->inn}}
					/{{$rec->car_org->kpp}}, {{$rec->car_org->bank_account_info}}</B></TD>
			<TD STYLE="border-right: 1px solid #000000"><br></td>
			<td/>
		</TR>
		<TR>
		...
		<TR>
			...
			<TD STYLE="border-bottom: 1px solid #000000" colspan=12 ALIGN=LEFT BGCOLOR="#FFFFFF">
				<B><!--{{$rec->org->boss_postname}} {{$rec->org->name}}-->
				{{$rec->car_org->boss_postname}}, {{$rec->car_org->name}}</B>
			</TD>
			<td/>

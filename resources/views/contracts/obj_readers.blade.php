    ...
    <div class="card mt-3 d-none d-sm-block">
        <div class="card-header">
            ...
            <div class="float-right">
                ...
                @if( $usrrights['save'])
                    <a href="{{ route('obj_readers.create',['sysobjid'=>151, 'objid'=>$rec->id])}}"
        ...
        @if (count($rec->readers)>0)
                ...
                <table class="table-condensed table-striped small" style="width: 100%;">
                    ...
                    @foreach($rec->readers as $itm)
                        ...
                        <tr class="align-top">
                            ...
                            <td class="text-right">
                                <a href="{{ route('obj_readers.edit',$itm->id)}}?returl={{Route::currentRouteName()}}"
            ...
            <div class="card-footer">
                ...
                @if (1==1 and $MustReadNoReadCnt>0)

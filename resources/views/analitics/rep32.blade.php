...
@section('content')
    ...
    <?php
    $thisTitle = "Анализ затрат на спецтехнику по данным отчетов о работе";
            ...
            <div class="col-md-12">
                ...
                <div class="params no-print card mt-3" style="min-width:400px;">
                    ...
                    <div class="card-body">
                        ...
                        <form name="forRep" id="forRep" method="post" action="{{ route('reports.rep32set') }}">
                            @csrf
...
//                                                                    $tDcStyle = "display:inline-block;";
                                        ...
                                        @endif
                                        @if (1==1 and count($data->contracts)>0)
                                        ...
                                        @if (1==1 and count($data->buildobjs)>1)
                                            <div class="form-group col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        @if (count($managers)>1)
                                            <div class="form-group col-md-3">
                                                ...
                                                {!! Form::select('s_mngrid', $managers, $search_params['s_mngrid'],
                                                                [
                                                                'class' => 'form-control',
                                                                'placeholder' => '',
                                                                ])
...
{{--									<a href="{{route('objevntlog',['sysobjid'=>15, 'objid'=>83,'route'=>Route::current()->getName()])}}">журнал</a>--}}
									<a href="{{route('objevntlog',['sysobjid'=>855, 'objid'=>32,'route'=>Route::current()->getName()])}}">журнал</a>
								</span>
                            </div>
                        </form>
                    </div>
...
{{--                            <td>Часов</td>--}}
                            <td>Сумма, руб</td>
                            <td>Кол-во смен</td>
                            <td class="brg">В среднем за смену, руб</td>
                            <?php
                            }?>
                            @if($datasetCnt>1)
{{--                                <td>Часы</td>--}}

                        ...
                        <form name="forRep01" id="forRep01" method="post"
                            ...
                            @if(1==1)
                                <div class="row">
                                    ...
                                    @if(1==1)
                                        <div class="form-group col-md-3">
                                            <label for="s_dep_name" class="">Подразделение:</label>
                                            {!! Form::text('s_dep_name', $search_params['s_dep_name'],
                                                            [
                                                            'class' => 'form-control',
                                                            'placeholder' => '-все-',
                                                            ])
        ...
        @if (isset($recs))
            ...
            <div class="page p-2 container-fluid">
                ...
                <table id="results"
                    ...
                    <thead>
                    <tr>
                        <th colspan="2">ФИО, должность, подразделение, организация</th>
                        <th>Начало работы</th>
                    </tr>
                    </thead>
                    ...
                    @foreach($recs as $rec)
                        ...
                        <tr>
                            ...
                            <td class="text-center ">{{isset($rec->begdate)?date_format(date_create($rec->begdate), 'd.m.Y'):'-'}}</td>
                        </tr>

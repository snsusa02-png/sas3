            ...
            <div class="col-md-12">
                <div class="card uper">
                    <div class="card-header">
                        Сотрудники клиента "<b>{{$org->name}}</b>" ({{$org->id}})
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a href="{{ route('orgstaff.create',$org->id)}}" class="btn btn-warning btn-sm"
                            ...
                            @foreach($stafflist as $itm)
                                ...
                                <tr class="{{$tr_itm_class}}">
                                    ...
                                    <td style="text-align: center;">
                                        <a href="{{ route('orgstaff.edit',$itm->id)}}" class="btn btn-sm btn-primary"

					...
					<div class="card mt-3">
						...
						<form name="forEdit" id="forEdit" method="post"
							...
							<div class="card-body">
								...
								<div class="form-group">
									<label for="name">Предназначена для объектов типа:</label>
									{!! Form::select('forsysobjid', $rec->sysobjs, $rec->forsysobjid
									,['class' => 'form-control',
									'required' => 'required',
									'placeholder' => '-укажите-',
									]) !!}
							...
							<table class="table-striped small p-2" style="width: 100%;" cellpadding="2">
								...
								<tr>
									...
									<td style="text-align: right;">
										<a href="{{ route('groups.create',['grptypeid'=>$rec->id,])}}"
								...
								@foreach($rec->groups as $itm)
									<tr>
										...
										<td style="text-align: right;">
											<a href="{{ route('groups.edit',$itm->id)}}"

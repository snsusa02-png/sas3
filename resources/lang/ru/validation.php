...
return [
    ...
    */
    ...
    'uploaded'             => 'Загрузка файла :input не удалась.',
    ...
    */
    ...
    'custom' => [
        ...
        'itmtypeid'=>['required' => 'Выберите категорию'],
        "sysfiletypeid"=>[
                'required' => 'Требуется указание типа загружаемых данных'
        ],
        'file4import'=>['required' => 'Необходимо указать файл для загрузки'],
        'dscntpcnt' => ["required"=>"Укажите размер скидки"],
        'it_st_id' => ['required' => 'Выберите категорию/тип товара'],

        'refitmid' => ["required"=>"Товар должен быть выбран из списка"],
    ],

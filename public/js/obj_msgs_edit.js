$(document).ready(function () {
    ...
    //     console.log($("#stfname").val());
    // });

    $("#add2contactlist").click(function (e) {
        //console.log($("#stfname").val());

        //var inp1 = $(foo).append($('<input />').attr('name', 'bar'));
        $("#contact-list").append('<div class="input-group mb-1 input-group-sm">'
            + '<div class="input-group-prepend">'
            + '<span class="input-group-text"><i class="fa fa-address-card-o" aria-hidden="true"></i></i></span>'
            + '</div>'
            + '<input type="text" name="username[]" class="username form-control small">'

...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: '/taskcalendar/get?' + auxParams,
        //events: SITEURL + "taskcalendar",
        // events: [
        //     {
        //         id: 'a809',
        //         title: 'my event',
        ...
        select: function (arg) {
            ...
            if (1 == 0) {
                ...
                // calendar.taskcalendar('renderEvent',
                //     {
                //         title: title,
                //         start: start,
                //         end: end,

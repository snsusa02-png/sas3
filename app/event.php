...
class event extends Model
{
    ...
    static public $prefix = 'events';
    static public $sysobjid = 951;
        ...
        if (count($recs) > 0) {
            ...
            foreach ($recs as $rec) {
                ...
                foreach ($rcpts as $rcpt) {
                    ...
                    user_notice::addOrUpdate(951, route("events.edit", $rec->id), $rcpt->id
                        , $subj
                        , $rec->descript

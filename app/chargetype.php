...
class chargetype extends Model
{
    ...
    static public $prefix = 'chargetype';
    static public $sysobjid = 1210;
...
//    {
//        return $this->belongsTo(chargetype::class, 'parent_id', 'id')->withDefault();
//    }
//
//    //дочерние записи
//    public function childs()
//    {
//        return $this->hasMany(chargetype::class, 'parent_id', 'id');
//    }
//

    public static function charge_periods()
    {
        return [
            ''  => 'разово',
            'D'  => 'ежедневно',
...
//            \Log::debug(var_dump($itmdata));
    ...
    static public function lstFor($params)
    {
        ...
        if (isset($params) and is_countable($params) and count($params) > 0) {
            ...
            $lst = self::from('chargetypes as it')
                ->whereRaw($sc)
                ->select('id', 'name')

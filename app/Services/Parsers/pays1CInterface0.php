...
class pays1CInterface0 implements impFileParser
{
...
//            \Log::debug("--------000000115--------:" . $payforms['000000115']);
            ...
            foreach ($xml->Платежи->Регистратор as $doc) {
                try {
                    ...
                    $docsum = StringUtil::to_number($doc['РегистраторСуммаОбщая'] ?? $doc['РегистраторСумма']);
...
//                        );
                        ...
                        if (isset($orgid)) {
                            ...
                            if (isset($extid)) {
                                ...
                                $paydir = ($doc['РегистраторВозврат'] == 'Да') ? -1 : +1;
                            }
                            //dd($payformid,$paydir);
                            //--------------------------------------------------------------------------------------

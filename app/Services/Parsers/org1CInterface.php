...
class org1CInterface implements impFileParser
{
...
//        $this->log->info(var_export($param, false));
    ...
    public function doit(\App\Services\Readers\impFileReader $reader)
    {
        ...
        $res = $this->load_1sorg_xml_job($reader->filename);
...
//    static public function load_1sorg_xml_job($filename, $user)
//    static public function load_1sorg_xml_job($filename, $userid)

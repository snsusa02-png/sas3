...
class wrkrep extends Model
{
    static public $prefix = 'wrkreps';
    static public $sysobjid = 1131;
    ...
    {
        return $this->hasMany(wrkrep_machine::class, 'wrkrep_id', 'id');
    }
...
//    }
    ...
    {
        return Cache::remember('wrkreps.years', now()->addMinutes(20)
            , function () {
                return self::selectraw('year(docdate) as yr')->distinct()
                    ->orderby('yr', 'DESC')->get()
                    ->pluck('yr', 'yr')->toArray();
            });
    }

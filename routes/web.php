...
Route::match(array('POST', 'GET'), '/reports/rep/57_i', "WrhDocReportController@rep57_i")->name('reports.rep57_i');
Route::match(array('POST', 'GET'), '/reports/rep/57_o', "WrhDocReportController@rep57_o")->name('reports.rep57_o');
...
Route::match(array('POST', 'GET'), '/reports/rep/62', "OrgChargeController@rep62")->name('reports.rep62');
...
Route::match(array('POST', 'GET'), '/reports/rep/66/{date}/{itmtypeid}', "WrhDocReportController@rep66")->name('reports.rep66');
Route::match(array('POST', 'GET'), '/reports/rep/67/{date}/{itmtypeid}', "WrhDocReportController@rep67")->name('reports.rep67');
...
Route::match(array('POST', 'GET'), '/reports/rep/73', "OrgChargeController@rep73")->name('reports.rep73');
Route::match(array('POST', 'GET'), '/reports/rep/74', "WrhDocReportController@rep74")->name('reports.rep74');
Route::match(array('POST', 'GET'), '/reports/rep/75', "OrgChargeController@rep75")->name('reports.rep75');
Route::match(array('POST', 'GET'), '/reports/rep/76', "DriverWorkReportController@rep76")->name('reports.rep76');
Route::match(array('POST', 'GET'), '/reports/rep/77', "DriverWorkReportController@rep77")->name('reports.rep77');
